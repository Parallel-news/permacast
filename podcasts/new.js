...
export async function handle(state, action) {
  ...
  if (input.function === "createPodcast") {
    ...
    if (caller !== contractOwner ) {
      throw new ContractError('invalid caller. Only the contractOwner can perform this action')
    }
  ...
  if ( input.function === "addEpisode") {
    ...
    if (! podcasts[index]) {
      throw new ContractError('podcast the given having index not found')
    }
  ...
  if (input.function === "deletePodcast") {
    ...
    if (! podcasts[index]) {
      throw new ContractError('podcast having the gievn index does not exist')
    }
  ...
  if (input.function === "editPodcastName") {
    ...
    if (! podcasts[index]) {
      throw new ContractError('podcast having the given index does not exist')
    }
  ...
  if (input.function === "editPodcastDesc") {
    ...
    if (! podcasts[index]) {
      throw new ContractError('podcast having the given ID does not exist')
    }
  ...
  if (input.function === "editEpisodeName") {
    ...
    if (! podcasts[index]) {
      throw new ContractError('podcast having the given ID not found')
    }

    if (! podcasts[index]["episodes"][id]) {
      throw new ContractError('episode having the given index not found')
    }
  ...
  if (input.function === "editEpisodeDesc") {
    ...
    if (! podcasts[index]["episodes"][id]) {
      throw new ContractError('episode having the given index id not found')
    }
  ...
  throw new ContractError('unknow function supplied')
}
